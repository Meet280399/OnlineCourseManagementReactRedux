...
describe("StudentService", () => {
  ...
  describe("update Student", () => {
    ...
    let stud = new Student();
    stud.studentId = 315;
    stud.studentName = "Aryan Thakran";
    stud.studentEmail = "aryan.thakran@gmail.com";
    stud.studentAddress = "Mumbai";
    stud.studentMobile = 8745327865;
    it("update the student by id", () => {
      service.updateStudent(stud).then((result) => {
        service.findStudentById(315).then((result) => {
          let student = result.data;
          expect(student.studentName).toBe("Aryan Thakran");
        });
      });
    });
  });
