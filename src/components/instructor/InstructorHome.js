...
import { deleteInstructor, fetchInstructors } from "../../redux/instructor/instructorActions";
function InstructorHome({ instructorsData, fetchInstructors, deleteInstructor }) {//bcm prop of comp
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        deleteInstructor: (instId) => { dispatch(deleteInstructor(instId)) },
    };
};
